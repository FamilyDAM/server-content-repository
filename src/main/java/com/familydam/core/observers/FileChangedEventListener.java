 ...
 */
public class FileChangedEventListener implements EventListener
{
    ...
    public FileChangedEventListener(Repository repository)
    {
                    ...
                    try {
                        ...
                        if( _path.endsWith("jcr:data")) {
                            ...
                            if (node.getPrimaryNodeType().isNodeType(JcrConstants.NT_FILE)) {
                                ...
                                reactor.notify("file.changed", Event.wrap(_path));
                            }
                        }
                    }catch(Exception ex){
                        log.error(ex);
